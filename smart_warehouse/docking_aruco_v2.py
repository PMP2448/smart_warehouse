...
class ArucoDocking(Node):
    def __init__(self):
        ...
        self.declare_parameter('k_w_lat', 0.5)  # Ganancia corrección lateral durante aproximación
        self.declare_parameter('k_w_angle', 0.4)  # Ganancia corrección angular durante aproximación
        self.declare_parameter('aligning_angle', 40)  # Ángulo inicial de alineamiento
        ...
        self.aligning_angle = self.get_parameter('aligning_angle').value
